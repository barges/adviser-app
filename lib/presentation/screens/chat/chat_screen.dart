      ...
      child: Scaffold(
        body: Scaffold(
          appBar: ChatConversationAppBar(
              ...
              publicQuestionId: chatCubit.chatScreenArguments.publicQuestionId,
                ...
                children: [
                  ...
                  Builder(
                    builder: (BuildContext context) {
                      final AppSuccess appSuccess = context
                          .select((ChatCubit cubit) => cubit.state.appSuccess);
              ...
              if (chatCubit.needActiveChatTab() && currentIndex == 0) {
                if (chatCubit.isPublicChat()) {
                  final bool showInputFieldIfPublic = context.select(
                      (ChatCubit cubit) => cubit.state.showInputFieldIfPublic);
