...
import '../../services/push_notification/push_notification_manager.dart' as _i9;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i8.MainCubit>(_i8.MainCubit(
    get<_i6.GlobalCachingManager>(),
    get<_i3.ConnectivityService>(),
  ));
  gh.singleton<_i9.PushNotificationManager>(_i10.PushNotificationManagerImpl());
