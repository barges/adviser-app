...
import '../../data/network/api/customer_api.dart' as _i22;
import '../../data/network/api/user_api.dart' as _i19;
import '../../data/repository_impl/fortunica_auth_repository_impl.dart' as _i24;
...
import '../../data/repository_impl/fortunica_customer_repository_impl.dart'
    as _i28;
import '../../data/repository_impl/fortunica_user_repository_impl.dart' as _i30;
import '../../domain/repositories/fortunica_auth_repository.dart' as _i23;
import '../../domain/repositories/fortunica_chats_repository.dart' as _i25;
import '../../domain/repositories/fortunica_customer_repository.dart' as _i27;
import '../../domain/repositories/fortunica_user_repository.dart' as _i29;
...
import '../../services/check_permission_service.dart' as _i17;
...
import '../../services/push_notification/push_notification_manager_impl.dart'
    as _i12;
import '../../services/sound_mode_service.dart' as _i15;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.singleton<_i15.SoundModeService>(_i15.SoundModeService());
  gh.singleton<_i16.AppInterceptor>(_i16.AppInterceptor(
    gh<_i10.MainCubit>(),
    gh<_i7.FortunicaCachingManager>(),
  ));
  gh.singleton<_i17.CheckPermissionService>(
      _i17.CheckPermissionService(gh<_i7.FortunicaCachingManager>()));
  ...
  gh.factory<_i19.UserApi>(() => _i19.UserApi(gh<_i18.Dio>()));
  gh.factory<_i20.AuthApi>(() => _i20.AuthApi(gh<_i18.Dio>()));
  gh.factory<_i21.ChatsApi>(() => _i21.ChatsApi(gh<_i18.Dio>()));
  gh.factory<_i22.CustomerApi>(() => _i22.CustomerApi(gh<_i18.Dio>()));
  gh.factory<_i23.FortunicaAuthRepository>(
      () => _i24.FortunicaAuthRepositoryImpl(gh<_i20.AuthApi>()));
  gh.factory<_i25.FortunicaChatsRepository>(
      () => _i26.FortunicaChatsRepositoryImpl(gh<_i21.ChatsApi>()));
  gh.factory<_i27.FortunicaCustomerRepository>(
      () => _i28.FortunicaCustomerRepositoryImpl(gh<_i22.CustomerApi>()));
  gh.factory<_i29.FortunicaUserRepository>(
      () => _i30.FortunicaUserRepositoryImpl(
            gh<_i19.UserApi>(),
            gh<_i7.FortunicaCachingManager>(),
          ));
  return getIt;
