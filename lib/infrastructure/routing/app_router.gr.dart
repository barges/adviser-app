...
class ZodiacServicesMessages
    extends _i47.PageRouteInfo<ZodiacServicesMessagesArgs> {
  ZodiacServicesMessages({_i48.Key? key})
      : super(
          ZodiacServicesMessages.name,
          path: 'zodiacServicesMessages',
...
class ZodiacCategoriesList
    extends _i47.PageRouteInfo<ZodiacCategoriesListArgs> {
...
class ZodiacCategoriesListArgs {
  ...
  @override
  String toString() {
    return 'ZodiacCategoriesListArgs{key: $key, selectedCategoryIds: $selectedCategoryIds}';
  }
}
