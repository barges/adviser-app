...
import 'package:zodiac/data/models/settings/phone_country_code.dart' as _i47;
...
class MainAppRouter extends _i45.RootStackRouter {
  ...
  final Map<String, _i45.PageFactory> pagesMap = {
    ...
    ZodiacPhoneCodeSearch.name: (routeData) {
      return _i45.AdaptivePage<_i47.PhoneCountryCode>(
        routeData: routeData,
...
/// generated route for
/// [_i3.AllBrandsScreen]
class AllBrands extends _i45.PageRouteInfo<void> {
  const AllBrands()
      : super(
          AllBrands.name,
          path: 'AllBrands',
...
class ZodiacPhoneNumber extends _i45.PageRouteInfo<ZodiacPhoneNumberArgs> {
  ZodiacPhoneNumber({
    _i46.Key? key,
    required _i51.Phone? phoneNumber,
  }) : super(
          ZodiacPhoneNumber.name,
          path: 'zodiacPhoneNumber',
...
class ZodiacPhoneCodeSearch extends _i45.PageRouteInfo<void> {
