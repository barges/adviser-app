...
import 'widgets/phone_code_app_bar.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => PhoneNumberCubit(
          ...
          zodiacGetIt.get<PhoneCountryCodesService>()),
                                      ...
                                      Expanded(
                                        child: Builder(builder: (context) {
                                          ...
                                          return AppTextField(
                                            ...
                                            label:
                                                SZodiac.of(context).phoneZodiac,
                                          );
                                        }),
                                      )
                                    ],
