...
class ZodiacServicesRepositoryImpl implements ZodiacServicesRepository {
  ...
  @override
  Future<ServiceResponse> deleteService(DeleteServiceRequest request) async {
    return await _api.deleteService(request);
  }

  @override
  Future<ServiceResponse> getServices(ServiceListRequest request) async {
  ...
  @override
  Future<BaseResponse> editService(EditServiceRequest request) async {
    return await _api.editService(request);
  }
}
